...
JOIN title AS t
  ON cc.movie_id = t.id AND t.production_year <= 2010 AND t.production_year >= 1950
...
JOIN movie_info AS mi
  ...
  AND mi.info IN ('Denish', 'Denmark', 'English', 'German', 'Germany', 'Norway', 'Norwegian', 'Sweden', 'Swedish')
