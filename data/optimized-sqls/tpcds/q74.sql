WITH year_total AS (
  ...
  JOIN date_dim AS date_dim
    ON date_dim.d_date_sk = store_sales.ss_sold_date_sk AND date_dim.d_year IN (2001, 2002)
  GROUP BY
  ...
  JOIN date_dim AS date_dim
    ON date_dim.d_date_sk = web_sales.ws_sold_date_sk AND date_dim.d_year IN (2001, 2002)
  GROUP BY
    customer.c_customer_id,
    customer.c_first_name,
    customer.c_last_name,
